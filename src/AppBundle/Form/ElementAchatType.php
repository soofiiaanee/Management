...
class ElementAchatType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('produit',EntityType::class, [
                    ...
                    'choice_label' => function($p) {
                                        return $p->getLibelle().' : '.$p->getReference();
                                    },
                    'required' => true,
                    ])
                ...
                ->add('prix',NumberType::class,array('required'=>true,'mapped' => true,
                    'label' => 'Prix','attr'=>array('required'=>false,'class'=>"form-control form-control-user","placeholder"=>"Prix Unitaire")));
    }/**
     * {@inheritdoc}
     */
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\ElementAchat'
        ));
    }
